    ...
    <div class="add">
        ...
        <input type="hidden" name="id" value="<?php echo ($info["id"]); ?>" />
            <ul class="form_address">
                <li>
                    <!-- <h3>收货人姓名: </h3> -->
                    <input class="text width_normal" value="<?php echo ($info["consignee"]); ?>" name="consignee" placeholder="请填写您的真实姓名" type="text">
...
<select name="qu" id="s3"></select>
                 	...
                 	<script language="javascript">
								new PCAS("sheng","shi","qu","<?php echo ($info["sheng"]); ?>","<?php echo ($info["shi"]); ?>","<?php echo ($info["qu"]); ?>");
				</script>
                
                <li>
                    <!-- <h3>详细地址: </h3> -->
                    <input value="<?php echo ($info["address"]); ?>" class="text width_normal" name="address" placeholder="如：华师生活北区10栋" type="text"><label class="field_message"><span class="field_notice"></span></label>
                </li>
                <li>
                    <!-- <h3>手机号码:</h3> -->
