...
<link rel="stylesheet" type="text/css" href="../Style/shop.css" /></head>
...
<script charset="utf-8" src="../Style/js/touchslider.dev.js" type="text/javascript"></script>
...
<?php if(count($_SESSION['cart'])==0){ ?>
   ...
   <h3 id="chose_all"><b class="ico">全选商品</b></h3>
     ...
     <?php if(is_array($item)): $i = 0; $__LIST__ = $item;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li id="cart_item_<?php echo ($vo["id"]); ?>">
              <p class="goods_info">
                  ...
                  <span class="tit">
                      ...
                      <span>数量:</span>
                      <span>
                          <img src="../Style/images/subtract.gif" onClick="decrease_quantity(<?php echo ($vo["id"]); ?>);" alt="decrease" style="vertical-align: middle;width=:16px">
                          ...
                          <img src="../Style/images/adding.gif" onClick="add_quantity(<?php echo ($vo["id"]); ?>);" alt="increase" style="vertical-align: middle;width=:16px">
                      </span><br>
                      <span>
                          <a class="del" href="javascript:;" onClick="drop_cart_item(<?php echo ($vo["id"]); ?>);"> <img src="../Style/images/del.png"  style="vertical-align: middle;height:20px;width=:20px"></a>
                      </span>
                  </span>
              </p>
              <p class="buy_info">
    ...
    <div class="buy_foot">
        ...
        <p class="jiesuan_btn">
            <a href="<?php echo U('Order/jiesuan');?>" class="btn"><span>去结算</span><img src="../Style/images/jiesuan.png" width="50%"></a>
        </p>
    </div>
    <?php } ?>
</div>
