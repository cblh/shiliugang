            ...
            <div class="mbar">
             ...
             <!--  <div class="vshop" id="divShopName"><a class="bindwx" href="#">已绑定</a><span class="sname">您的微商城名称: 智风科技有限公司</span><a title="资料已认证" class="vok" href="#">已认证</a><sapn class="red">您的店铺已过期，请与管理员联系</sapn></div>-->
               ...
               <div class="shoplink" id="divShopLink">
                    微商城链接：<input type="text" value="http://<?php echo $_SERVER['SERVER_NAME']; ?>__ROOT__" title="选中，按Ctrl + C可复制！"; onclick="this.select()" class="seltext hand" readonly="readonly" id="txtShopLink" name="txtShopLink">
               </div>
               
                <div class="shoplink" >
                    微商接口配置URL：<input type="text" value="http://<?php echo $_SERVER['SERVER_NAME']; ?>__APP__?m=Weixin&a=index" title="选中，按Ctrl + C可复制！";  onclick="this.select()" class="seltext hand" readonly="readonly" id="txtShopLink" name="txtShopLink">
               </div>
               <div class="shoplink" >
...
<div id="footer">
    <div class="f-box">
        <div class="copy">版权所有 &copy; 智风科技 2013-2015</div>
    </div>
</div>
</body>
</html>