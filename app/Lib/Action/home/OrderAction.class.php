	...
	public function pay()//出订单
	{
		...
		{	
		   ...
		   $dingdanhao .= rand(1000,2000);
			...
			$delivery_time=$this->_post('delivery_time');//送货时间
		...
		echo "<script>location.href='api/wapalipay/alipayapi.php?WIDseller_email=".$alipay['alipayname']."&WIDout_trade_no=".$orderId."&WIDsubject=".$orderId."&WIDtotal_fee=".$orders['order_sumPrice']."'</script>";exit;
			}
